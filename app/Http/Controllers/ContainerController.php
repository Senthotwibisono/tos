...
class ContainerController extends Controller
{
    ...
    public function indexContainerAll(Request $request)
    {
      ...
      $query = Item::orderBy('ctr_i_e_t', 'desc')->orderBy('container_key', 'desc');
    ...
    // Android
    public function indexHistoryAndroid()
    {
        $data['title'] = 'History Container';
        $data['kapal'] = Kapal::orderBy('ves_id', 'asc')->get();
        $data['jumlahKapal'] = Kapal::count();
        ...
        return view('container.android.main', $data);
    }

    public function indexContainerAllAndroid(Request $request)
    {
      $data['title'] = "Report Container";

      $query = Item::where('ctr_active_yn', '=', 'Y')->orderBy('ctr_i_e_t', 'desc')->orderBy('container_key', 'desc');
      $data['intern'] = Item::distinct('ctr_intern_status')->pluck('ctr_intern_status');
      $data['kapal'] = Kapal::all();
      $data['yards'] = Yard::distinct('YARD_BLOCK')->pluck('YARD_BLOCK');
      ...
      return view('container.android.sortByAll', $data);
    }

    public function indexSortVesAndroid($id, Request $request)
    {
      $kapal = Kapal::where('ves_id', $id)->first();
      $data['id'] = $id;
      $data['title'] = "Report Container by Vessel " . $kapal->ves_name . ' ' . $kapal->voy_out;
      ...
      return view('container.android.sortByVessel', $data);
    }
