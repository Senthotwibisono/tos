...
<div class="page-heading">
  <h3><?= $title ?></h3>
  <p>Review Data Pranota Extend Form & Kalkulasi</p>
</div>
<div class="page content mb-5">
  <form action="/delivery/form/extend/storeBilling" method="POST" enctype="multipart/form-data">
    @CSRF
    ...
    <div class="card">
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-4">
            <div class="form-group">
              <label for="">Expired Date Before</label>
              <input type="text" class="form-control" readonly value="<?= $deliveryForm->exp_date ?>">
            </div>
          </div>
          <div class="col-4">
            <div class="form-group">
              <label for="">Extended To</label>
              <input type="text" class="form-control" readonly value="<?= $deliveryForm->extended_exp_date ?>">
            </div>
          </div>
          <div class="col-12">
            <div class="form-group">
