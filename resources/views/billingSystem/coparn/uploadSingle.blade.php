...
<div class="page-content">
  ...
  <section class="row">
    <form action="{{ route('storeDataSingle')}}" method="POST" enctype="multipart/form-data">
      @CSRF
      <div class="row">
        <div class="col-6">
          <div class="card">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select name="ctr_status" class="js-example-basic-multiple form-control" style="height: 150%;">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="gross" class="form-control">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="">Operator</label>
                            <input type="text" name="ctr_opr" class="form-control">
                        </div>
                    </div>
                  </div>
                </div>
