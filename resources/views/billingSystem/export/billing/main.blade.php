                  ...
                  <div class="row">
                     <div class="col-6">
                       <div class="form-check form-switch">
                         <input class="form-check-input" type="checkbox" name="inv_typeZahir[]" value="OSK">
                         <label class="form-check-label" for="checkbox-dsk">OSK</label>
                       </div>
                     </div>
                     <div class="col-6">
                       <div class="form-check form-switch">
                         <input class="form-check-input" type="checkbox" name="inv_typeZahir[]" value="OS">
  ...
  async function exportZahir() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        const url = '{{route('invoice.zahir.export')}}';
        ...
        if (response.ok) {
          ...
          if (hasil.success) {
            Swal.fire({
              ...
              // console.log(data);
              const urlCSV = '{{route('invoice.zahir.csvExport')}}';
