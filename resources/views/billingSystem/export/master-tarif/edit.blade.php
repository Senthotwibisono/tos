...
<div class="page-content">
    <div class="card">
        ...
        <hr>
        <form action="{{ route('updateMTexport') }}" method="POST">
            @csrf
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <div class="form-group">
                            <input type="number" name="paket_stuffing" value="{{$masterTarif->paket_stuffing}}"  class="form-control">
                        </div>
                    </div>
                    <div class="col-3">
                        <label>Cargo Dooring</label>
                        <div class="form-group">
                            <input type="number"  name="cargo_dooring" value="{{$masterTarif->cargo_dooring}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-3">
                        <label>JPB Ex-truck</label>
                        <div class="form-group">
                            <input type="number"  name="jpb_extruck" value="{{$masterTarif->jpb_extruck}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-3">
                        <label>Sewa Crane</label>
                        <div class="form-group">
                            <input type="number"  name="sewa_crane" value="{{$masterTarif->sewa_crane}}" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
