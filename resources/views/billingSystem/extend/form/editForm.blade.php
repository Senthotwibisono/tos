...
<div class="page-content mb-5">
  <section class="row">
    <form action="{{ route('updateFormImportExtend')}}" method="POST" id="formSubmit" enctype="multipart/form-data">
      @CSRF
      <div class="card">
        <div class="card-body">
          <div class="row">
          ...
          <div class="row mt-5">
            ...
            <div class="col-12" id="selector">
              ...
              <select name="inv_id"  class="js-example-basic-single form-control" id="invId" style="height: 150%;">
               ...
               @foreach($oldInv as $inv)
                <option value="{{$inv->id}}"{{$form->do_id == $inv->id ? 'selected' : ''}}>{{$inv->inv_no}}</option>
               @endforeach
              </select>
            </div>
            <br>
            ...
            <div class="col-12">
              ...
              <option disabeled value>Pilih Container !</option>
