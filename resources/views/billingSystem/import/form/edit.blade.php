...
<div class="page-content mb-5">
  <section class="row">
    <form action="{{ route('updateFormImport')}}" method="POST" id="updateForm" enctype="multipart/form-data">
      @CSRF
      <div class="card">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-4">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="form_id" value="{{$form->id}}" id="formId">
              </div>
            </div>
            <div class="col-4">
              <div class="form-group">
          ...
          <div class="row mt-5" id="do_fill">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <select required name="do_number_auto" id="do_number_auto" class="form-control select2" style="height: 150%;">
                      <option value="{{ $form->do_id }}" selected>{{ $form->doOnline->do_no }}</option>
                    </select>
            ...
            <div class="col-12 col-md-4">
              <div class="form-group">
                ...
                <input name="do_exp_date" id="do_exp_date" required readonly type="date" class="form-control flatpickr-range mb-3" placeholder="09/05/2023" value="{{$form->doOnline->expired ?? '-'}}">
              </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="form-group">
                <label for="">Bill of Loading Number</label>
                <input name="boln" id="boln" required readonly type="text" class="form-control" placeholder="Bill Of Loading Number" value="{{$form->doOnline->bl_no ?? '-'}}">
              </div>
            </div>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="discountDSK" name="discount_dsk" value="{{$form->discount_dsk ?? 0}}">
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">
              <label for="">Discount OS</label>
                <p>Di Isi dengan Nomial !!</p>
              <input type="text" class="form-control" id="discountDS" name="discount_ds" value="{{$form->discount_ds ?? 0}}">
            </div>
          </div>
         </div>
          ...
          <div class="row mt-5">
            ...
            <button type="button" id="submitButton" onClick="submitForm()" class="btn btn-success">Submit</button>
