...
<div class="page content mb-5">
  <form action="{{route('invoiceImport.form.createInvoice')}}" method="POST" enctype="multipart/form-data" id="updateForm">
    @CSRF
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row mt-3">
              @if($dsk == 'Y')
               @include('billingSystem.import.form.new.preinvoice.dsk')
              @endif     
              @if($ds == 'Y')
               @include('billingSystem.import.form.new.preinvoice.ds')
              @endif     
        </div>
        <div class="row mt-3">
          <div class="col-12 text-right">
            ...
            <a href="{{route('deliveryEdit', ['id' => $form->id])}}" class="btn btn-primary text-white"><i class="fa fa-pen"></i> Edit</a>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire(
                            ...
                            window.location.href = '{{route('deliveryMenu')}}'; // Arahkan ke halaman beranda setelah penghapusan sukses
                        });
                    },
                    error: function(xhr) {
