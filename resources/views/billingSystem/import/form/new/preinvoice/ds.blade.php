    ...
    <div class="card-body">
      <div class="row text-white p-3">
          ...
          @php
            ...
            $totalDSBanget = $totalDS + $adminDS;
            $totalAmountDS = ($totalDS + $adminDS) -  $discountDS;
            $ppnDS = ($totalAmountDS * 11)/100;
            $grandTotalDS = $totalAmountDS + $ppnDS; 
          @endphp
          <div class="col-6 mt-4" style="text-align:right;">
            <h4 class="text-white"> Rp. {{number_format($totalDSBanget, 2, ',', '.')}}</h4>
            ...
            <input type="hidden" name="totalDS" value="{{$totalDSBanget}}">
