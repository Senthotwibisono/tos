...
<div class="page-content">
    <div class="card">
        ...
        <hr>
        <form action="{{ route('storeMT') }}" method="POST">
            @csrf
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <input type="number" name="paket_stripping" class="form-control">
                        </div>
                    </div>
                    <div class="col-6">
                        <label>Pemindahan Petikemas</label>
                        <div class="form-group">
                            <input type="number"  name="pemindahan_petikemas" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
