        ...
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="/billing/import/master-tarif-{{$os->id}}" class="btn btn-outline-success"><i class="fa fa-plus"></i>add Tarif</a>
                </div>
                <div class="card-body">
                            ...
                            @foreach($masterTarif as $mt)
                                @if($mt->os_id == $os->id)
                                   <tr>
                                        ...
                                        <td>{{$mt->ctr_size}}</td>
                                        <td>
                                            <a href="/billing/import/master-tarif/edit-{{$mt->id}}" class="btn btn-outline-warning">Edit</a>
                                        </td>
                                   </tr>
                                @endif
                            @endforeach
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('orderService')}}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <label>Type: </label>
                    <div class="form-group">
                        <input type="text" name="ie" class="form-control" value="Import" readonly>
                    </div>
                </div>
