...
<div class="page-content">
  ...
  <section class="row">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <form action="{{ route('zahir-invoice-others')}}" method="GET" enctype="multipart/form-data">
          <div class="row">
            <div class="col-4">
  ...
  <section class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Tabel Data Billing Others (Belum Bayar)</h4>
    ...
    <section class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Tabel Data Billing Others (Piutang)</h4>
            <p>Rekap Data Billing</p>
          </div>
          <div class="card-body">
            <!-- <form action="{{ route('report-invoice-import')}}" method="GET" enctype="multipart/form-data">
