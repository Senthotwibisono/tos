...
<div class="page-content">
    <div class="card">
        ...
        <form action="{{ route('index-stevadooring-RBM_Update')}}" method="post">
            @csrf
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" name="id" value="{{$rbm->id}}">
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="loose_cargo" value="{{$rbm->loose_cargo}}" placeholder="isi dengan 0 jika kosong" required>
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="gt_kapal" value="{{$rbm->gt_kapal}}" placeholder="isi dengan 0 jika kosong" required>
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group">
                        <label for="">Etmal</label>
                        <input type="text" class="form-control" name="etmal" placeholder="isi dengan 0 jika kosong" required pattern="^\d+([.,]\d+)?$" value="{{$rbm->etmal}}" title="Please enter a valid decimal number (e.g., 12.34 or 12,34)">
                    </div>
                </div>
            </div>
