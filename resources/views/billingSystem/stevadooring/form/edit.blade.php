...
<div class="page-content mb-5">
  <section class="row">
    <form action="{{ route('stevadooringUpdate')}}" method="POST" id="formSubmit" enctype="multipart/form-data">
      @CSRF
      <div class="card">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-4">
              ...
              <div class="form-group">
                <select required name="customer" id="customer" class="js-example-basic-single form-control">
                    ...
                    <option value="{{$cust->id}}" {{ $cust->id == $inv->cust_id ? 'selected' : '' }}>{{$cust->name}}</option>
                    @endforeach
                </select>
              </div>
            </div>
            ...
            <div class="col-4">
              <div class="form-group">
                ...
                <input required type="text" class="form-control" id="npwp" name="npwp" value="{{$inv->npwp}}" placeholder="Pilih Customer Dahulu!.." readonly>
              </div>
            </div>
            <div class="col-4">
              <div class="form-group">
              <label for="">Address</label>
                <input required type="text" class="form-control" id="address" name="address" value="{{$inv->alamat}}" placeholder="Pilih Customer Dahulu!.." readonly>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
          ...
          <div class="row mt-5">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="tambat_kapal" id="flexSwitchCheckDefault" @if($inv->tambat_kapal == 'Y') checked @endif>
                        <label class="form-check-label" for="flexSwitchCheckDefault">Jasa Tambat Kapal</label>
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="stevadooring" id="flexSwitchCheckDefault" @if($inv->stevadooring == 'Y') checked @endif>
                        <label class="form-check-label" for="flexSwitchCheckDefault">Stevadooring</label>
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="shifting" id="flexSwitchCheckDefault" @if($inv->shifting == 'Y') checked @endif>
