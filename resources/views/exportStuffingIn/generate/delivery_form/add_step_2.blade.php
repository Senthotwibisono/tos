...
<div class="page content mb-5">
  <section class="row">
    <form action="/export/stuffing-in/generate/storestep2" method="POST" enctype="multipart/form-data">
      @CSRF
            ...
            ?>
              ...
              foreach ($data2 as $data_arr) { ?>
                <?php if ($ccdelivery->deliveryForm->isExtended != 1) { ?>
                  ...
                  <input type="hidden" name="data2[<?= $index ?>][tarif]" value="<?= $data->lift_off ?>">
                  <input type="hidden" name="data2[<?= $index ?>][amount]" value="<?= $ccdelivery->grandTotal[$i]->liftOff ?>">
