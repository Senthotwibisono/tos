...
<section>
    <div class="card">
        <div class="card-header">
            <h4>Form Input Gate In Ambil Empty</h4>
        </div>
        <form action="{{ route('confirmInGateMT')}}" method="post">
            @csrf
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-sm-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-1">:</div>
                    <div class="col-sm-6">
                        <input type="datetime-local" class="form-control" name="truck_in_date" required>
                    </div>
                </div>
