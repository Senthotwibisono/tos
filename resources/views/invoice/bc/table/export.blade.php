    ...
    <div class="card-body">
        ...
        <div class="tab-content text-justify" id="load_ini">   
            ...
            <div class="tab-pane fade" id="pkbe" role="tabpanel" aria-labelledby="list-pkbe-list">
                <div class="col-12 border">
                    <div class="card-header">
                    @include('invoice.bc.button.pkbe')  
                    </div>
                    <div class="card-body">
                          ...
                          <tbody>
                            @foreach($details_pkbe as $pkbe)
                              <tr>
                                  ...
                                  <td>{{$pkbe->NAMA_EKS}}</td>
                                  <td>{{$pkbe->NPWP_EKS}}</td>
                                  <td>{{ $container_pkbe[$pkbe->NOPKBE]}}</td>
                                  <td>
                                  <a href="javascript:void(0)"class="btn icon icon-left btn-outline-info detail-cont" data-id="{{$pkbe->CAR}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
                                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                        </svg> Detail</a>
                                  </td>                         
