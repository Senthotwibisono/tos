  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="editUserModalLabel">Gate Kapal Sandar IKS Relokasi Pelindo</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" class="form-control" id="truck_out_date">
        </div>
        <div class="form-group">
...
<script>
    $(document).ready(function() {
        $('#tableGateIn').dataTable({
            ...
            scrollX: true,
            scrollY: '50vh',
            ajax: '{{route('gate.pelindoImport.data')}}',
            order: [[2, 'desc']],
            columns: [
            ...
            ajax: {
                ...
                data: function(params) {
                    return {
                        search: params.term,
                        page: params.page || 1,
                        type: 'pelindoImport' // <- ini dikirim ke controller
                    };
                },
...
<script>
    ...
    async function cancelGateIn(button) {
        ...
        if (result.isConfirmed) {
            ...
            const url = '{{route('gate.pelindoImport.cancel')}}';
            const response = await globalResponse(data, url);
            hideButton(button);
            if (response.ok) {
                const hasil = await response.json();
