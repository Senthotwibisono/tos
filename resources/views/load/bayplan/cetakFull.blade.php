...
<html>
<head>
    <title>Bayplan Load {{$vesSelect->ves_name}} -- {{$vesSelect->voy_out}}</title>
</head>
...
<div class="head-title">
    <h1 class="text-center m-0 p-0">Bayplan Load</h1><br>
    <p class="text-center m-0 p-0"><strong>{{$vesSelect->ves_name}} - {{$vesSelect->voy_out}}</strong></p>
</div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if($box && $row->bay_row % 2 == 0)
                                <div class="kotak{{($box->container_key != null && $box->ctr_i_e_t == 'E') ? ' filled' : ''}}">
                                @if($box->container_key != null && $box->ctr_i_e_t == "E")
