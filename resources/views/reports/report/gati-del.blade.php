        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Gate In Delivery (Container 10)</h3>
...
$(function(){
    ...
    $.ajax({
        url: "/review-get-container-gati-del",
        type: "GET",
        data: { ves_id: vesId },
        success: function(response) {
            ...
            response.forEach(function(item) {
                ...
                newRow.append('<td>' + item.truck_in_date + '</td>');
...
$(document).on('click', '.btn-print-pdf-disch', function(e) {
    ...
    $.ajax({
        url: "{{ url('/generate-report-gati-del') }}",
        method: 'POST',
...
document.getElementById("cetakpdf").addEventListener("click", function() {
        ...
        var url = "{{ url('/generate-report-gati-del') }}?ves_id=" + vesId;
