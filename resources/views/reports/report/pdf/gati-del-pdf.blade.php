...
<html>
<head>
    <title>Gate In Delivery (Container 10) {{$ves_name}}</title>
</head>
<style type="text/css">
    body{
...
<div class="head-title">
    <h1 class="text-center m-0 p-0">Gate In Delivery (Container 10)</h1>
</div>
            ...
            @foreach($item as $index => $item)
                @php
                    ...
                    echo '</table></div></div><div class="page-break"></div><div class="table-section bill-tbl w-100 mt-10"><table class="table w-100 mt-10">'; // Penutup dan pembukaan tabel baru pada halaman baru
                        ...
                        echo '<tr><th class="w-50">Invoice No</th><th class="w-50">Job No</th><th class="w-50">Truck No</th><th class="w-50">Truck In Date</th><th class="w-50">Container No</th><th class="w-50">Size</th><th class="w-50">Status</th><th class="w-50">Type</th></tr>'; // Header tabel baru
