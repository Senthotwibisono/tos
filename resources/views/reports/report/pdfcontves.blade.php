...
<html>
<head>
    <title>Disch List {{$ves_name}}</title>
</head>
<style type="text/css">
    body{
...
<div class="head-title">
    <h1 class="text-center m-0 p-0">DISCH LIST</h1>
</div>
...
<div class="table-section bill-tbl w-100 mt-10">
    <table class="table w-100 mt-10">
        <tr>
            ...
            <th class="w-50">Belum Bongkar</th>
        </tr>
        <tr>
            <td>
                <div class="box-text">
            ...
            @foreach($item as $index => $item)
                @php
                    ...
                    echo '</table></div></div><div class="page-break"></div><div class="table-section bill-tbl w-100 mt-10"><table class="table w-100 mt-10">'; // Penutup dan pembukaan tabel baru pada halaman baru
                        ...
                        echo '<tr><th class="w-50">Bay</th><th class="w-50">Row</th><th class="w-50">Tier</th><th class="w-50">Container No</th><th class="w-50">Size</th><th class="w-50">Status</th><th class="w-50">Type</th></tr>'; // Header tabel baru
                        echo '<tr class="bay-title"><td colspan="7">Bay ' . $bay . '</td></tr>'; // Menampilkan judul bay
                        $previousBay = $bay;
                    }
                @endphp
            <tr align="center">
