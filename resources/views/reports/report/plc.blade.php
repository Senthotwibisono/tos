        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Placement Reports (Container 03)</h3>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            response.forEach(function(item) {
                var newRow = $('<tr>');
                newRow.append('<td>' + item.yard_block + '</td>');
                newRow.append('<td>' + item.yard_slot + '</td>');
                newRow.append('<td>' + item.yard_row + '</td>');
                newRow.append('<td>' + item.yard_tier + '</td>');
...
document.getElementById("cetakpdf").addEventListener("click", function() {
        ...
        var url = "{{ url('/generate-report-plc') }}?ves_id=" + vesId;
