    ...
    <div class="card-body">
      ...
      <div class="tab-content text-justify" id="load_ini">
        <div class="tab-pane fade show active" id="dalam" role="tabpanel" aria-labelledby="list-dalam-list">
          @include('stuffing.tabel.stuffingDalam')

        </div>
        <div class="tab-pane fade" id="luar" role="tabpanel" aria-labelledby="list-luar-list">
          @include('stuffing.tabel.stuffingLuar')
          @include('stuffing.modal.modal-stuffing-luar')
        </div>
      </div>
    </div>
  </div>
</section>
@include('stuffing.modal.modal-stuffing-dalam')
...
<script>
  new simpleDatatables.DataTable('#tableStuffingLuar');
</script>
