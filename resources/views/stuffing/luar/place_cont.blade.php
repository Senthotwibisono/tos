      ...
      <div class="modal-body">
        ...
        <div class="form-body" id="place_cont">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-success ml-1 update_place_cont_luar"><i class="bx bx-check d-block d-sm-none"></i><span class="d-none d-sm-block">Confirm</span></button>
          </div>
        </div>
      </div>
    </div>
