<div class="modal fade text-left w-100" id="detail-stuffing" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
...
<!-- Detail-Cont -->
<div class="modal fade text-left w-100" id="detail-container" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
