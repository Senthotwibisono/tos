                                ...
                                <div class="row" style="border:1px solid blue;">
                                    <div class="col-md-6 col-12" >
                                        <div class="form-group">
                                            ...
                                            <option value="-">-</option>
                                                <?php $__currentLoopData = $vessel_master; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $master): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($master->ves_code); ?>"><?php echo e($master->ves_code); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <option value="-">-</option>
                                                <?php $__currentLoopData = $vessel_service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-3 col-12">
                                        <div class="form-group">
                                            ...
                                            <option value="-">-</option>
                                                <?php $__currentLoopData = $berth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($b->berth_no); ?>"><?php echo e($b->berth_no); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        </div>
                                    </div>
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td ><input type="datetime-local" value="<?php echo e($currentDateTimeString); ?>"  name="arrival_date" class="form-control"  disabled ></td>
                                    </tr>
                                    <tr>
                                        <td class="text-bold-500"><h5>Anchorage Date</h5></td>
                                        <td><input type="datetime-local"  name="est_anchorage_date" class="form-control"></td>
                                        <td><input type="datetime-local" value="<?php echo e($currentDateTimeString); ?>" name="act_anchorage_date" class="form-control" disabled ></td>
                                    </tr>
                                    <tr>
                                        <td class="text-bold-500"><h5>Pilot Date</h5></td>
                                        <td><input type="datetime-local"  name="est_pilot_date" class="form-control"></td>
                                        <td ><input type="datetime-local" value="<?php echo e($currentDateTimeString); ?>" name="act_pilot_date" class="form-control" disabled ></td>
                                    </tr>                                    
                                    <tr>
                                        <td class="text-bold-500"><h5>Berthing Date</h5></td>
                                        <td><input type="datetime-local"  name="est_berthing_date" class="form-control"></td>
                                        <td ><input type="datetime-local" value="<?php echo e($currentDateTimeString); ?>" name="berthing_date" class="form-control" disabled > </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td ><input type="datetime-local" value="<?php echo e($currentDateTimeString); ?>" name="act_start_work_date" class="form-control" disabled ></td>
                                    </tr>
                                    <tr>
                                        <td class="text-bold-500"><h5>End Work Date</h5></td>
                                        <td><input type="datetime-local"  name="est_end_work_date" class="form-control"></td>
                                        <td ><input type="datetime-local" value="<?php echo e($currentDateTimeString); ?>" name="act_end_work_date" class="form-control" disabled ></td>
                                    </tr>
                                    <tr>
                                        <td class="text-bold-500"><h5>Deparature Date</h5></td>
                                        <td><input type="datetime-local"  name="etd_date" class="form-control"></td>
                                        <td ><input type="datetime-local" value="<?php echo e($currentDateTimeString); ?>" name="deparature_date" class="form-control" disabled ></td>
                                    </tr>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" id="-column" class="form-control" value="<?php echo e($currentDateTimeString); ?>" placeholder="" name="open_stack_date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" id="-column" class="form-control" value="<?php echo e($currentDateTimeString); ?>" placeholder="" name="doc_clossing_date">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="-column">Cargo Closing Date</label>
                                            <input type="datetime-local" id="-column" class="form-control" value="<?php echo e($currentDateTimeString); ?>" placeholder="" name="clossing_date">
                                        </div>
                                    </div>
                                    <hr>
                                    <hr>
                                    ...
                                    <div class="col-md-3 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="-column" class="form-control" value ="<?php echo e(Auth::user()->name); ?>" placeholder="<?php echo e(Auth::user()->name); ?>"  required readonly>
                                            <input type="hidden" id="-column" class="form-control" value ="<?php echo e(Auth::user()->id); ?>" placeholder="<?php echo e(Auth::user()->name); ?>" name="user_id" required readonly>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-3 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" id="-column" class="form-control" value="<?php echo e($currentDateTimeString); ?>" name="update_time" required readonly>
                                        </div>
                                    </div>
                                    <hr>
                                    <hr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('partial.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tos\resources\views/planning/vessel/create.blade.php ENDPATH**/ ?>