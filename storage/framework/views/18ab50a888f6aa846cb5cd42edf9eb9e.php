...
<div class="page content mb-5">
  <section class="row">
    <form action="/invoice/add/storeupdatestep1?id=<?= $form->id ?>" method="POST" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
      <div class="card">
...
<?php echo $__env->make('partial.invoice.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Fdw File Storage 1\CTOS\dev\frontend\tos-dev-local\resources\views/invoice/delivery_form/update_step_1.blade.php ENDPATH**/ ?>