                            ...
                            <div class="col-md-6 col-12">
                              <div class="form-group">
                                ...
                                <select class="form-select" id="vesid" name="ves_id">
                                  ...
                                  <option value="<?php echo e($vi->ves_id); ?>"><?php echo e(str_pad($vi->ves_id,4,'0', STR_PAD_LEFT)); ?>-<?php echo e($vi->ves_code); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                              </div>
                            </div>
                                  ...
                                  <div class="col-md-12 col-12">
                                    <div class="form-group">
                                      ...
                                      <select class="form-select" id="" name="load_port" required>
                                        ...
                                        <option value="<?php echo e($pm->un_port); ?>"><?php echo e($pm->un_port); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
                                    </div>
                                  </div>
                          ...
                          <div class="col-md-6 col-12">
                            <div class="form-group">
                              ...
                              <select class="form-select" id="vesid_edit" name="ves_id">
                                ...
                                <option value="<?php echo e($vy->ves_id); ?>"><?php echo e(str_pad($vy->ves_id,4,'0', STR_PAD_LEFT)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            </div>
                          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('partial.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Fdw Files\CTOS\dev\frontend\tos-dev-local\resources\views/planning/bayplan/main.blade.php ENDPATH**/ ?>