...
<div class="container">
    ...
    <table class="table table-hover" id="">
                        ...
                        <tbody>          
                        <?php for($i = $row - 1; $i >= 0; $i--): ?>
        <div class="row-container">
            <div class="tier-label left-label"><?php echo e($evenNumbers[$numberIndex]); ?></div>

            <?php for($j = 0; $j < $tier; $j++): ?>
...
<?php echo $__env->make('partial.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Fdw File Storage 1\CTOS\dev\frontend\tos-dev-local\resources\views/disch/view.blade.php ENDPATH**/ ?>