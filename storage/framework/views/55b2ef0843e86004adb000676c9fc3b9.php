              ...
              foreach ($data2 as $data_arr) { ?>
                <?php if ($ccdelivery->deliveryForm->isExtended != 1) { ?>
                  ...
                  <?php } else { ?>
                    ...
                    <input type="hidden" name="orderService" value="export">
                  <?php }
                  ?>
...
<?php echo $__env->make('partial.invoice.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Fdw File Storage 1\CTOS\dev\frontend\tos-dev-local\resources\views/export/delivery_form/add_step_2.blade.php ENDPATH**/ ?>