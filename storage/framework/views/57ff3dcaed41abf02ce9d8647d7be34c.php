              ...
              <table class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" id="table1">
                ...
                <tbody>
                  ...
                  foreach ($deliveries as $data) { ?>
                    <?php if ($data->orderService == "export") { ?>
...
<?php echo $__env->make('partial.invoice.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Fdw File Storage 1\CTOS\dev\frontend\tos-dev-local\resources\views/export/delivery_form/dashboard.blade.php ENDPATH**/ ?>