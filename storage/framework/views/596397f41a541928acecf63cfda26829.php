...
<div class="page-content mb-5">
  <section class="row">
    <form action="/export/stuffing/add/storestep1" id="formSubmit" method="POST" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
      <div class="card">
              ...
              <div class="col-12">
                ...
                <select name="container[]" id="containerSelector" class="js-example-basic-multiple form-control" style="height: 150%;" multiple="multiple">
                  ...
                  <?php foreach ($container as $data) { ?>
                    <?php if ($data->ctr_intern_status == "04" && $data->isChoosen != "1") { ?>
...
<?php echo $__env->make('partial.invoice.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Fdw File Storage 1\CTOS\dev\frontend\tos-dev-local\resources\views/export/stuffing/add_step_1.blade.php ENDPATH**/ ?>