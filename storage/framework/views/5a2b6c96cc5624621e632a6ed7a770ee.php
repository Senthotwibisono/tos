                ...
                <table class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($d['ves_name']); ?> || <?php echo e($d['voy_no']); ?></td>
                            <td><?php echo e($d['container_no']); ?></td>
                            <td><?php echo e($d['bay_slot']); ?> || <?php echo e($d['bay_row']); ?> || <?php echo e($d['bay_tier']); ?></td>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="choices form-select" id="id_kapal" name="ves_id" required>
                                    ...
                                    <option value="<?php echo e($voy->ves_id); ?>"><?php echo e($voy->ves_name); ?>--<?php echo e($voy->voy_out); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                  ...
                  <option value="-">-</option>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" id="tanggal" class="form-control" value="<?php echo e($currentDateTimeString); ?>" name="load_date" readonly>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('partial.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tos\resources\views/load/main.blade.php ENDPATH**/ ?>