                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="">Choose Ves Id</span>
                                <select class="form-select" id="vesid" name="ves_id">
                                    ...
                                    <option value="<?php echo e($itm->ves_id); ?>"><?php echo e($itm->ves_name); ?> - <?php echo e($itm->voy_no); ?></option>
...
<?php echo $__env->make('partial.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tos\resources\views/disch/view.blade.php ENDPATH**/ ?>