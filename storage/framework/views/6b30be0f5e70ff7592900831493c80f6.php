                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="">Choose Ves Id</span>
                                <select class="form-select" id="vesid" name="ves_id">
                                    ...
                                    <option value="<?php echo e($itm); ?>"><?php echo e(str_pad($itm,4,'0', STR_PAD_LEFT)); ?></option>
...
$(document).on('click', '.btn-print-pdf', function(e) {
    ...
    $.ajax({
        url: "<?php echo e(url('/generate-pdf-disch')); ?>",
        method: 'POST',
...
document.getElementById("cetakpdf").addEventListener("click", function() {
        ...
        var url = "<?php echo e(url('/generate-pdf-disch')); ?>?ves_id=" + vesId;
...
<?php echo $__env->make('partial.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Fdw Files\CTOS\dev\frontend\tos-dev-local\resources\views/reports/report/review.blade.php ENDPATH**/ ?>