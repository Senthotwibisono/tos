<ul class="menu">
    ...
    <li class="sidebar-item  has-sub <?php if(Request::is('planning/*')): ?> active <?php endif; ?>">
        ...
        <ul class="submenu <?php if(Request::is('planning/*')): ?> active <?php endif; ?>">
            ...
            <li class="submenu-item <?php if(Request::is('planning/ship_planning')): ?> active <?php endif; ?>">
                <a href="/planning/ship_planning">Ship Planning</a>
            </li>
            </li>
            <li class="submenu-item <?php if(Request::is('planning/profile-kapal')): ?> active <?php endif; ?>">
    ...
    <li class="sidebar-item  has-sub <?php if(Request::is('disch/*') || Request::is('load/*')): ?> active <?php endif; ?>">
        <a href="#" class='sidebar-link'>
            <i class="bi bi-collection-fill"></i>
            <span>Disch/Load</span>
        </a>
        <ul class="submenu <?php if(Request::is('disch/*') || Request::is('load/*')): ?> active <?php endif; ?>">
            <!-- <li class="submenu-item ">
            ...
            <hr>
            <li class="submenu-item <?php if(Request::is('load/confirm_load')): ?> active <?php endif; ?>">
                <a href="/load/confirm_load">Load Confirm</a>
            </li>
            <li class="submenu-item <?php if(Request::is('load/container_loading')): ?> active <?php endif; ?>">
    ...
    <li class="sidebar-item  has-sub <?php if(Request::is('yard/*') || Request::is('stripping') || Request::is('stuffing')): ?> active <?php endif; ?>">
        <a href="#" class='sidebar-link'>
            <i class="fa-solid fa-landmark-flag"></i>
            <span>Yard</span>
        </a>
        <ul class="submenu  <?php if(Request::is('yard/*') || Request::is('stripping') || Request::is('stuffing')): ?> active <?php endif; ?>">
            <!-- <li class="submenu-item ">
            ...
            <li class="submenu-item <?php if(Request::is('stuffing')): ?> active <?php endif; ?>">
                <a href="/stuffing">Stuffing</a>
            </li>
            <hr>
            <li class="submenu-item <?php if(Request::is('yard/trucking')): ?> active <?php endif; ?>">
    ...
    <li class="sidebar-item  has-sub <?php if(Request::is('delivery/*') || Request::is('reciving/*') || Request::is('stuffing/*')): ?> active <?php endif; ?>">
        ...
        <ul class="submenu <?php if(Request::is('delivery/*') || Request::is('reciving/*') || Request::is('stuffing/*')): ?> active <?php endif; ?>">
            ...
            <hr>
            <li class="submenu-item <?php if(Request::is('delivery/balik-relokasi')): ?> active <?php endif; ?>">
                <a href="/delivery/balik-relokasi">Gate MT Balik IKS & Relokasi Pelindo</a>
            </li>
            <hr>

            <li class="submenu-item <?php if(Request::is('reciving/gate-in')): ?> active <?php endif; ?>">
                <a href="/reciving/gate-in">Get in Reciving</a>
            </li>
            <li class="submenu-item <?php if(Request::is('reciving/gate-out')): ?> active <?php endif; ?>">
    ...
    <li class="sidebar-item  has-sub <?php if(Request::is('edi/*')): ?> active <?php endif; ?>">
        ...
        <ul class="submenu <?php if(Request::is('edi/*')): ?> active <?php endif; ?>">
            ...
            <li class="submenu-item <?php if(Request::is('edi/coparn')): ?> active <?php endif; ?>">
    ...
    <li class="sidebar-item has-sub <?php if(Request::is('reports/*')): ?> active <?php endif; ?>">
        ...
        <ul class="submenu <?php if(Request::is('reports/*')): ?> active <?php endif; ?>">
            ...
            <li class="submenu-item <?php if(Request::is('reports/plc')): ?> active <?php endif; ?>">
                <a href="/reports/plc">PLC Reports</a>
            </li>
            <li class="submenu-item <?php if(Request::is('reports/str')): ?> active <?php endif; ?>">
                <a href="/reports/str">Srtipping Reports</a>
            </li>
            <li class="submenu-item <?php if(Request::is('reports/gati-del')): ?> active <?php endif; ?>">
                <a href="/reports/gati-del">Gati-Del Reports</a>
            </li>
            <li class="submenu-item <?php if(Request::is('reports/gato-del')): ?> active <?php endif; ?>">
                <a href="/reports/gato-del">Gato-Del Reports</a>
            </li>
            <hr>
            <li class="submenu-item <?php if(Request::is('reports/export')): ?> active <?php endif; ?>">
    ...
    <!-- <li class="sidebar-title">Extra UI</li>
        ...
        </ul> --><?php /**PATH C:\xampp\htdocs\tos\resources\views/partial/sidebar.blade.php ENDPATH**/ ?>