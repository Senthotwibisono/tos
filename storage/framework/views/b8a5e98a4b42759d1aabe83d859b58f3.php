          ...
          <div class="row">
            <div class="col-12">
              <div class="btn-group mb-3" role="group" aria-label="Basic example">
                <a href="/export/stuffing/delivery" type="button" class="btn btn-success">
                  Data Export Stuffing
                </a>
              </div>
            </div>
          </div>
              ...
              <table class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" id="table1">
                <thead>
                  <tr>
                    ...
                    <th>Order Service</th>
                    <th>Dibuat Pada</th>
                    <th>Status Invoice 1</th>
                    <th>Status Invoice 2</th>
                    <th>Piutang</th>
                    <th>Pranota</th>
                    <th>Invoice1</th>
                    <th>Invoice2</th>
                ...
                <tbody>
                  <?php foreach ($invoices as $value) { ?>
                    <?php if ($value->orderService == "stuffing") { ?>
                      <tr>
...
<?php echo $__env->make('partial.invoice.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Fdw File Storage 1\CTOS\dev\frontend\tos-dev-local\resources\views/export/dashboardStuffing.blade.php ENDPATH**/ ?>