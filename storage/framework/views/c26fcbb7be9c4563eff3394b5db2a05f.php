...
<div class="page-content">
          ...
          <div class="row">
            <div class="col-12">
              <div class="btn-group mb-3" role="group" aria-label="Basic example">
                <a href="/export/stuffing/add/step1" type="button" class="btn btn-success">
                  Tambah Stuffing Form
                </a>
              </div>
            </div>
          </div>
  ...
  <section class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Stuffing Form Data Table</h4>
          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
        <div class="card-body">
          <div class="row mt-5">
              ...
              <table class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" id="table1">
                ...
                <tbody>
                  ...
                  foreach ($deliveries as $data) { ?>
                    <?php if ($data->orderService == "stuffing") { ?>
...
<?php echo $__env->make('partial.invoice.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Fdw File Storage 1\CTOS\dev\frontend\tos-dev-local\resources\views/export/stuffing/dashboard.blade.php ENDPATH**/ ?>