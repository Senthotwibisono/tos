...
<div class="page content mb-5">
  <section class="row">
    <form action="/spps/add/storestep2" method="POST" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
        ...
        <div class="card-body">
          ...
          <div class="row mt-5">
            <div class="col-12 text-right">
              ...
              <a href="/spps/add/update_step1?id=<?= $ccdelivery->deliveryForm->id ?>" class="btn btn btn-warning">Edit</a>
...
<?php echo $__env->make('partial.spps.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Fdw Files\CTOS\dev\frontend\tos-dev-local\resources\views/spps/delivery_form/add_step_2.blade.php ENDPATH**/ ?>