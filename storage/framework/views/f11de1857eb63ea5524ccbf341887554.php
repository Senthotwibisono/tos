  ...
  <div class="card-body">
    ...
    <div class="card-body">
                <div class="list-group list-group-horizontal-sm mb-1 text-center" role="tablist">
                    <a class="list-group-item list-group-item-action active" id="list-exp-list" data-bs-toggle="list" href="#exp" role="tab">Export</a>
                    <a class="list-group-item list-group-item-action" id="list-peaExp-list" data-bs-toggle="list" href="#peaExp" role="tab">Dok Pabean Export</a>
                    <a class="list-group-item list-group-item-action" id="list-pkb-list" data-bs-toggle="list" href="#pkbe" role="tab">Dok PKBE</a>
                </div>
        <div class="tab-content text-justify" id="load_ini">   
            <div class="tab-pane fade show active" id="exp" role="tabpanel" aria-labelledby="list-exp-list">
                <div class="col-12 border">
                    ...
                    <tbody>
                      <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $np): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($container[$np->NONPE]); ?></td>
                            <td>
                            <a href="javascript:void(0)"class="btn icon icon-left btn-outline-info detail-cont-exp" data-id="<?php echo e($np->NO_DAFTAR); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
                                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                        </svg> Detail</a>
                            </td>                         
            ...
            <div class="tab-pane fade" id="pkbe" role="tabpanel" aria-labelledby="list-pkbe-list">
                <div class="col-12 border">
                    <div class="card-header">
                    <?php echo $__env->make('invoice.bc.button.pkbe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
                    </div>
                    <div class="card-body">
                    <table class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" id="table2pkbe">
                    <thead>
                              <tr>
                                  <th>No</th>
                                  <th>No PKBE</th>
                          ...
                          <tbody>
                            <?php $__currentLoopData = $details_pkbe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkbe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                  <td><?php echo e($loop->iteration); ?></td>                            
                                  <td><?php echo e($pkbe->NOPKBE); ?></td>
                                  <td><?php echo e($pkbe->TGLPKBE); ?></td>
                                  <td><?php echo e($pkbe->NAMA_EKS); ?></td>
                                  <td><?php echo e($pkbe->NPWP_EKS); ?></td>
                                  <td><?php echo e($container_pkbe[$pkbe->NOPKBE]); ?></td>
                                  <td>
                                  <a href="javascript:void(0)"class="btn icon icon-left btn-outline-info detail-cont" data-id="<?php echo e($pkbe->CAR); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
                                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                        </svg> Detail</a>
                                  </td>                         
...
<?php /**PATH C:\xampp\htdocs\tos\resources\views/invoice/bc/table/export.blade.php ENDPATH**/ ?>