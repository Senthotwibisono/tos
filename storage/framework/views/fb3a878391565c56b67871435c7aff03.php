        ...
        <div class="grid-body">
            ...
            <div class="row">
              <div class="col-xs-12 col-8 my-auto">
                <h2>Invoice<br>
                  ...
                  <br>
                  <span class="small">Invoice No. <?= $invoices->invoice->invoiceNumber2 ?></span>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <?php if ($invoices->invoice->data7 != null) { ?>
                    <?php foreach ($invoices->invoice->data7 as $value) { ?>
                      <tr>
                        <td><?= $value->title ?></td>
                        <td><?= $value->jumlah ?></td>
                        <td><?= $value->size ?></td>
          ...
          <div class="row p-3">
            ...
            <div class="col-xs-12 col-6" style="text-align: right;">
              <p><strong>Rp. <?= rupiah($invoices->invoice->data8->totalamount) ?>,00 ~</strong></p>
              <p><strong>Rp. <?= rupiah($invoices->invoice->data8->admin) ?>,00 ~</strong></p>
              <p><strong>Rp. <?= rupiah($invoices->invoice->data8->tax) ?>,00 ~</strong></p>
              <p><strong>Rp. <?= rupiah($invoices->invoice->data8->grandtotal) ?>,00 ~</strong></p>
            </div>
            <div class="col-12">
              <p>Terbilang <strong>"<?= terbilang($invoices->invoice->data8->grandtotal) ?> Rupiah"</strong></p>
            </div>
          </div>
        </div>
      </div>
...
</html><?php /**PATH E:\Fdw File Storage 1\CTOS\dev\frontend\tos-dev-local\resources\views/export/stuffing/paid_invoice/index2.blade.php ENDPATH**/ ?>